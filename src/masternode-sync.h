...
static const int MASTERNODE_SYNC_TICK_SECONDS    = 5;
static const int MASTERNODE_SYNC_TIMEOUT_SECONDS = 60; // our blocks are 40 seconds so 60 seconds should be fine
